...
class Solution:
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        Plan:
        Stack
        Create cars array. Contains [position[i], time_to_finish] pairs.
        Reverse sort the cars array according to 0-index.
        Loop through cars.
            Append car to the stack.
            If there's a stack, and stack[-1][1] <= stack[-2][1], then the [-1] car will form a fleet with the [-2]
            car, so pop the stack.
