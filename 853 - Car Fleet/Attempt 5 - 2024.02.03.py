...
class Solution:
    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        Plan:
        Stack
        1. Create cars. Loop through positions and append [position[i], time_to_finsh] to cars.
        2. Init stack empty.
        3. Reverse sort cars.
        4. Loop through cars.
            5. Append cars[i] to the stack.
            6. If there is a stack and if stack[-1][1] < stack[-2][1], then pop the stack
        7. Return the len of the stack
        '''
        stack =[]
        cars = []
