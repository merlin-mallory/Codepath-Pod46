...
class Solution:
    def reorderList(self, head: Optional[ListNode]) -> None:
        ...
        Plan:
        Linked List:
        Find the midpoint with slow/fast pointer technique.
        Set the right_half to slow.next.
        Set slow.next to None.
        Set head to left_half.
        Reverse right_half.
        Loop through left_half and right_half, rewiring nodes together.
        """
        slow = head
        fast = head
