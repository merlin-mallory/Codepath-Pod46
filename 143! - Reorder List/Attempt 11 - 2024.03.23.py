...
class Solution:
    def reorderList(self, head: Optional[ListNode]) -> None:
        ...
        Find the midpoint of the list with the slow/fast pointer method.
        Set right_seg = slow.next, set slow.next to None.
        Reverse right_seg.
        Loop through left_seg and right_seg, and interweave the nodes
        """
        # Setup left_seg and right_seg
        slow = head
        fast = head
        ...
        # Interweave left_seg and right_seg
