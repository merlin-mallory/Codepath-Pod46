...
class Solution:
    def reorderList(self, head: Optional[ListNode]) -> None:
        ...
        Plan:
        1. Find the mid with the slow/fast pointer method.
        2. Set right_half = slow.next, and then set slow.next = None, and left_half = head.
        3. Reverse the right_half.
        3. Loop through left_half and right_half, and rewire the pointers in alternating order.
        4. We don't need to return anything.
        Time: O(n)
        Space: O(1)
        Edge: None
        """
        ...
        while left_half and right_half:
            left_temp = left_half.next
            right_temp = right_half.next

            left_half.next = right_half
            right_half.next = left_temp

            left_half = left_temp
            right_half = right_temp
