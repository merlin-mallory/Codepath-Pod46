...
class Solution:
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
        ...
        Create dfs(node).
            ...
            Recursive Case 1: left_height = dfs(node.left)
            Recursive Case 2: right_height = dfs(node.right)
            Work 1: cur_dia = 2 + left_height + right_height
            Work 2: max_dia = max(max_dia, cur_dia)
