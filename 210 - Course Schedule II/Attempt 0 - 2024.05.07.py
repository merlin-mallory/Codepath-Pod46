...
class Solution:
    def findOrder(self, numCourses: int, prerequisites: List[List[int]]) -> List[int]:
        ...
        Time: O(E+V), where E = len(prerequisites), and V = numCourses
        Space: O(E+V). course_to_prereq requires E space, and the recursive stack/sets require V space.
        Edge: Prerequisites could be empty
        '''
        import collections
