...
class Solution:
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        Plan:
        Linked List Creation via Hashmap
        Create old_to_new dict. Keys: Old nodes, Values: New nodes.
        Loop through head.
            Create a ListNode in old_to_new[cur], set equal to cur.val
        Loop through head.
            Grab old_to_new[cur], set to new_node.
            Set new_node.next and new_node.random
