...
class Solution:
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        Plan:
        Linked List via Hashmap.
        Create old_to_new dict.
        Loop through head. Fill up the old_to_new dict with new nodes and values.
        Second loop through head. Use the old_to_new dict to connect the .next and .random pointers.
