class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        '''
        # Sliding Window
        # Create s_window counter dict, max_len.
        import collections
        ...
        while r < len(s):
            # Add s[r] to s_window.
            s_window[s[r]] += 1
            # Check if s_window is valid (r - l + 1 - max(s_window.values()) <= k. If that's the case, then update
            # max_len. Otherwise, decrement s_window[s[l] and l++
