...
class Solution:
    def removeNthFromEnd(self, head: Optional[ListNode], n: int) -> Optional[ListNode]:
        ...
        Plan:
        Linked List
        Create a fast pointer, increment it n times. Then create a slow pointer at head.
        Loop while there's a fast pointer. The slow pointer will stop at the node before the desired deletion point.
        So just rewire that single pointer.
        Return dummy.
        '''
