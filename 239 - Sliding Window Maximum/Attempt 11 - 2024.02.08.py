...
class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        Plan:
        Sliding Window
        Create monotonic decreasing order stack (store indices instead of vals), final_arr.
        Loop through nums.
            Clean the left side of the deque: if deque[0] < l, then popleft.
            Clean the right side of the deque: if nums[deque[-1]] < nums[r], then pop
            Add cur_val to the deque.
            If r+1 > k:
