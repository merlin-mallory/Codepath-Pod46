...
class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        Create deque (monotonic decreasing order).
        Create final_arr.
        Loop through nums.
            If deque, clean the left side of the deque
            If deque, clean the right side of the deque
            Append nums[r] to the deque
            If r+1 >= k, append deque[0] to final_arr, l++
            r++
        Return final_arr.
        Time: O(n)
        Space: O(1)
