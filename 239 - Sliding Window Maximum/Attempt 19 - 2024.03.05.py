...
class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        Plan:
        Monotonic Decreasing Order Deque
        Create deque, final_arr.
        l, r = 0, 0
        Loop while r < len(nums).
            Clean the left side of the deque. If l > deque[0], popleft and discard.
            Clean the right side of the deque. If nums[r] >= nums[deque[-1]], popright and discard.
        ...
        l, r = 0, 0
        while r < len(nums):
            while deque and l > deque[0]: deque.popleft()
