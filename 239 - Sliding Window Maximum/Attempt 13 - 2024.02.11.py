...
class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        Plan:
        Create monotonic decreasing order deque.
        Loop through nums
            Clean leftside of the deque
            Clean rightside of the deque
            Append nums[i] to the deque
            If r+1 >= k:
                Append deque[0] to the final_arr
                l++
            r++
        Return final_arr
        Time: O(n)
