...
class Solution:
    def reverseKGroup(self, head: Optional[ListNode], k: int) -> Optional[ListNode]:
        ...
        Plan:
        Create fetch_kth_node(node) function. Returns a node.
        ...
        Loop while True.
            ...
            Reverse k nodes within mid_seg
            Reattach mid_seg to left_seg and right_seg
            Move left_seg pointer to next node.
        Return dummy.next
