...
class Trie:
    ...
    Plan:
    Trie
    Time: O(n) for insert, where n = len of word for insert/search, or len of prefix for startsWith
    Space: O(n) for insert, whe n = len of word for insert, O(1) for search and startsWith
    Edge: None
    '''
