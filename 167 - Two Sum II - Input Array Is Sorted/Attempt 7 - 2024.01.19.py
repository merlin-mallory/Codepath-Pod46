class Solution:
    def twoSum(self, numbers: List[int], target: int) -> List[int]:
        ...
        Plan:
        Two pointers
        1. Initialize pointers. l = 0 , r = len(numbers) -1.
        2. Loop while l < r
            3. Calculate current_sum
            4. If current_sum > target, move the right pointer -1
            5. Elseif current_sum < target, move the left pointer +1
            6. Else we found current_sum == target
                7. So return [l+1, r+1]
        """
