class Solution:
    def twoSum(self, numbers: List[int], target: int) -> List[int]:
        ...
        Plan:
        1. Looks like two points because of the space restriction.
        2. l = 0, r = len(numbers)-1.
        3. While l < l:
            4. Calculate current_sum.
            5. If current_sum > target, then we need to reduce, so decrement r-1.
            6. If current_sum < target, then we need to grow, so increment l+1
            7. If current_sum = target, then return [l+1, r+1]
        """
        l, r = 0, len(numbers)-1
        while l < r:
