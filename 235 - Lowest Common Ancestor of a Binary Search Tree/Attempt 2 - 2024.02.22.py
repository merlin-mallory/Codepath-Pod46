...
class Solution:
    def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
        ...
        We will find the LCA when (cur.val > cur.left.val) and (cur.val < cur.right.val). Basically the exit
        condition for the binary search.
        We need to create an isMirror(p, q) function to determine when a common ancestor is found.
        '''
        cur = root
        while cur:
