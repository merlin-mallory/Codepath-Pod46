...
class Solution:
    def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
        ...
        Plan:
        The LCA will be the breakpoint where cur.right < cur.val < cur.left
        We can traverse the tree with DFS. If cur.val > both p and q, go left. If cur.val < both p and q,
        go right. Otherwise return the node as LCA.
        Time: O(log n)
        Space: O(h)
        Edge: None
        '''
