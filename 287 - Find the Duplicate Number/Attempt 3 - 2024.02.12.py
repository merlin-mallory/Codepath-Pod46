...
class Solution:
    def findDuplicate(self, nums: List[int]) -> int:
        ...
        Linked List
        Floyd's Algorithm
        Use slow/fast pointers to locate the position before the start of the cycle.
        Iterate from nums[0] and the slow pointer until they match, that will be the start of the cycle, which will
