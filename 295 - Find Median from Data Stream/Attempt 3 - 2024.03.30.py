class MedianFinder:
    ...
    Plan:
    Maxheap for left half, minheap for right half, rebalance when length difference exceeds 1.
    Keep track of total_len, and return appropriate values for both odd and even scenarios.
    Time: O(n log n)
    Space: O(n)
    Edge: None
    '''
