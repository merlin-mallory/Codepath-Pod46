...
class Solution:
    def isValidBST(self, root: Optional[TreeNode]) -> bool:
        ...
        Create dfs(node, left_bound, right_bound) function. Returns up a boolean indicating the validity of the tree.
            ...
            Recursive Case 1: left_bool = dfs(node.left, left_bound, node.val)
            Recursive Case 2: right_bool = dfs(node.right, node.val, right_bound)
